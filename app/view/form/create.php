    ...
    <section class="">
        <div class="row">
            ...
            <div class="col-6" id="formNameContainer">
                <p>Formularname: <span id="formName"></span> <i class="fas fa-edit editableIcons" id="formNameEdit"></i> <i class="far fa-times-circle editableIcons" id="formNameEditClose"></i></p>
            </div>
    ...
    <section class="">
        <div class="row">
            ...
            <div class="col-9 border p-3" id="formContainer">
                <div id="sortable"></div>
                <div class="card mt-2 createdFormField" id="field1">
                    <div class="card-body">  
        ...
        <div class="row">
            ...
            <div class="col-9">
               ...
               <p id="success" class="text-success text-center mt-3"></p>
            </div>
            <div class="col-12 d-flex flex-row-reverse m-0 p-0" id="actionBtnContainer">
                <button class="btn btn-primary mt-4" id="safeForm">Formular jetzt erstellen!</button>
            </div>
        </div>
